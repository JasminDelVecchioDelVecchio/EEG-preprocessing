...
opts = hlp_varargin2struct(varargin, ...
    ...
    {'scale_by','ScaleBy'},'allold',...         % the data set according to which the display should be scaled (can be allold, allnew, wndold, or wndnew)
...
on_update();
    ...
    function repaint(relPos,moved)
        ...
        scale = ((ylr(2)-ylr(1))/size(new.data,1)) ./ (opts.yscaling*iqrange); 
