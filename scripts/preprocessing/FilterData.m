...
% Filters markers' tracks according to Vissani et al. 2019
% data - vector having #samples x #coordinates
% cutoff - cutoff frequency for the lowpass filter
% fs - sampling frequency
% WL - windows length to smooth the data
...
%         dataFiltSM = smoothdata(dataFiltLP, 'sgolay', WL);
